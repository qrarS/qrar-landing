...
export default function SiteApp() {
  return <SiteLanguageProvider><LandingContentProvider><BrowserRouter><AnalyticsListener/><Routes><Route path="/" element={<LandingPage/>}/><Route path="/about" element={<About/>}/><Route path="/privacy" element={<Privacy/>}/><Route path="/terms" element={<Terms/>}/><Route path="/interests" element={<RegisterInterest/>}/><Route path="/Intersters" element={<Navigate to="/interests" replace/>}/><Route path="*" element={<SiteNotFound/>}/></Routes></BrowserRouter></LandingContentProvider></SiteLanguageProvider>;
}

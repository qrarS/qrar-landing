...
| `section_view` | IntersectionObserver on landing-page sections (threshold 0.4, ~300ms dwell), once per section per page load. | Which sections visitors actually see before converting or leaving. | section_id: top, how_it_works, response_story, features, audience, pricing, use_cases, najd, start |
